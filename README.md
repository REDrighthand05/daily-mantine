<div align="center">
  <h1>✦ Daily Mantine ✦</h1>
  <p><strong>A desktop side-panel productivity experiment.<br>Built with Mantine v7, Tauri v2 &mdash; now archived.</strong></p>
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/stack-HeroUI%20v2-228BE6?style=flat-square" alt="HeroUI">
...
```
frontend     React 19 · TypeScript · Mantine v7 · Tailwind v3 · Zustand · i18next
...
|---|---|---|
| **daily-mantine** | [Mantine v7](https://mantine.dev) + Tailwind v3 | ✅ Final release |
...
**[⬇ Download the final release](https://github.com/REDrighthand05/daily-mantine/releases/tag/v1.2.1)**
